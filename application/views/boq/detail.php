        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-bar-chart-o fa-fw"></i> Sitem Pemeliharaan Produk | <?php echo $title ?>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 ">
                            <table class="boq-customer pull-right">
                                ...
                                <tr><td class="title"><strong>No. PO</strong></td><td><?php echo $boq_data->purchase_order; ?></td></tr>
