        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-bar-chart-o fa-fw"></i> Sistem Pemeliharaan Produk | Tambah Group Pengguna Sistem
                </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="col-sm-8">
<!--                                    <input name="submit" value="Add" class="btn btn-success pull-right" type="submit">
-->                                    <p>
